...
jQuery.ready.promise = function( obj ) {
	if ( !readyList ) {
		...
		// If IE event by.epam.java_training.mihail_poliansky.final_project.model is used
		} else {
...
function getWidthOrHeight( elem, name, extra ) {
	...
	// use the active box-sizing by.epam.java_training.mihail_poliansky.final_project.model to add/subtract irrelevant styles
	return ( val +
